...
namespace QLVay
{
    public partial class Form3 : Form
    {
        ...
        private void btnGhi_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn chưa điền tên người vay");
                txtNgVay.Focus();
                return;
            }
            if (txtSoTien.Text != "")
            ...
            if (status == "Insert")
            {
                ...
                string query = "INSERT INTO dbo.QLChoVay VALUES('" + txtMaChoVay.Text.Trim() + "', '" + txtNgVay.Text.Trim() + "', '" + txtSoTien.Text.Trim() + "','" + dtpNgayVay.Value.ToString("MM/dd/yyyy") + "', '" + dtpNgayTra.Value.ToString("MM/dd/yyyy") + "','" + txtLaiSuat.Text.Trim() + "','" + cboId.Text.Trim() + "','" + tienlai + "')";
                SqlCommand cmd = new SqlCommand(query, conn);
            ...
            else
            {
                ...
                string query = "UPDATE dbo.QLChoVay SET TenNguoiVay = '" + txtNgVay.Text.Trim() +
                    ...
                    txtLaiSuat.Text.Trim() + "', id ='" + cboId.Text.Trim() + "' TienLaiDuKien = '" + tienlai + "' WHERE MaChoVay = '" + txtMaChoVay.Text.Trim() + "'";
                SqlCommand cmd = new SqlCommand(query, conn);
                var result = cmd.ExecuteNonQuery();
                if (result > 0)
                {
